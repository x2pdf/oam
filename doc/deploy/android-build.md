...
| versionName | `26.1.0` |
| versionCode | `2601000`（编码规则：major×1000000 + minor×1000 + patch） |
...
| `android/app/build.gradle` | `applicationId "com.oam.app"`，`versionCode 2601000`，`versionName "26.1.0"` |
...
| `android/app/build.gradle` | `versionName` | `"26.1.0"` |
