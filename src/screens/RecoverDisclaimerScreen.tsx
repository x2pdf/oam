...
export default function RecoverDisclaimerScreen() {
  ...
  const disclaimers = [
    t('wallet.recoverDisclaimer1'),
    t('wallet.recoverDisclaimer2'),
    t('wallet.recoverDisclaimer3'),
    t('wallet.recoverDisclaimer4'),
  ];

  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 20 }]}>
        <Text variant="headlineSmall" style={styles.title}>{t('wallet.recoverDisclaimerTitle')}</Text>
        ...
        <View style={styles.checkboxContainer}>
          ...
          <Text
            ...
            onPress={() => setChecked(!checked)}
          >
            {t('wallet.recoverDisclaimerCheckbox')}
          </Text>
        </View>
